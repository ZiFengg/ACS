...
public class OneThrid_Register {
    ...
    public static final String DX_CODE = "111111";
...
//                for (int s = begincell; s < endcell; s ++){
                ...
                Thread.sleep(2000);
                driver.findElement(By.id("com.mz.onethird_beta:id/usernameEt")).sendKeys((CharSequence) getCellData(cell1,evaluator));
//                driver.findElement(By.id("com.mz.onethird_beta:id/et_pic_code")).sendKeys(TX_CODE);
                ...
                driver.findElement(By.id("com.mz.onethird_beta:id/loginPwdEt")).sendKeys(DL_PSD);
                driver.findElement(By.id("com.mz.onethird_beta:id/payPwdEt")).sendKeys(ZF_PSD);
                driver.findElement(By.id("com.mz.onethird_beta:id/inviteCodeEt")).sendKeys((CharSequence) getCellData(cell2,evaluator));
